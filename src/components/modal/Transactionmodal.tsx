...
const TransactionModel: React.FC<ModalProps> = ({ children, onClose }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center py-10 lg:px-10 rounded-lg">
        <div
          className={`bg-[#03315D] rounded-lg relative w-full lg:w-1/2  transition-transform duration-300 ${isVisible ? "translate-y-0" : "translate-x-full"
            }`}
        >
